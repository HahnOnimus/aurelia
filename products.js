...
<<<<<<< HEAD
    },
    {
        ...
        description: "Digitize your educational institution with attendance tracking, grade management, parent portals, and online learning integration. All in one platform!",
        price: 270000,
        old: 600000,
        discount: 55,
        images: [
            "products-images/school-1.jpeg",
            "products-images/school-2.jpeg",
            "products-images/school-3.jpeg"
        ],
        paymentLink: "https://paystack.com/pay/pxcj0vh53i"
    },
    {
        id: 8,
        name: "ClientFlow CRM Elite",
        description: "Boost sales and customer relationships with our powerful CRM. Features pipeline management, automated follow-ups, and detailed analytics dashboards.",
        price: 300000,
        old: 500000,
        discount: 40,
        images: [
    ...
    {
        id: 9,
        name: "AccuBooks Accounting Suite",
        description: "Simplify your finances with automated bookkeeping, tax preparation, and financial reporting. Designed for small businesses and accountants.",
        price: 245000,
        old: 450000,
        discount: 45,
        images: [
            "products-images/book-1.png",
            "products-images/book-2.png",
            "products-images/book-3.png"
        ],
        paymentLink: "https://paystack.com/pay/q1eojdfzbv"
    },
    {
        id: 10,
        name: "Elite HRMS",
        description: "Modernize your HR department with payroll automation, performance tracking, and employee self-service portals. The future of human resources!",
        price: 380000,
        old: 720000,
        discount: 47,
        images: [
            "products-images/hrms-1.png",
            "products-images/hrms-2.png",
            "products-images/hrms-3.png"
        ],
        paymentLink: "https://paystack.com/pay/8jtp2my05g"
    },
    {
        id: 11,
        name: "SupportDesk Pro Software",
        description: "Deliver exceptional customer service with ticket management, live chat, and knowledge base features. Reduce response times and boost satisfaction.",
        price: 350000,
        old: 500000,
        discount: 30,
        images: [
            "products-images/help-1.png",
            "products-images/help-2.png",
            "products-images/help-3.png"
        ],
        paymentLink: "https://paystack.com/pay/qkn1uyrbzp"
    },
    {
        id: 12,
        name: "Lagos Business Leads Goldmine",
        description: "Access 1,000+ verified business leads in Lagos with decision-maker contacts. Perfect for B2B sales teams looking to expand their network.",
        price: 35000,
        old: 100000,
        discount: 65,
        images: [
        ...
        paymentLink: "https://paystack.com/pay/lnqg1uo9mp"
    },
    {
        id: 13,
        name: "Decision Makers Directory",
        description: "Connect with 8,000+ high net-worth individuals across USA. Includes company details, industry insights, and direct contact information.",
        price: 80000,
        old: 300000,
        discount: 73,
        images: [
            "products-images/8kleads-1.png",
            "products-images/8kleads-2.png",
            "products-images/8kleads-3.png"
        ],
        paymentLink: "https://paystack.com/pay/mroy9m0eyb"
    },
    {
        id: 14,
        name: "USA Business Leads Database",
        description: "100,000+ pre-qualified US business contacts ready for your outreach campaign. Updated monthly with fresh leads across all industries.",
        price: 250000,
        old: 1200000,
        discount: 72,
        images: [
        ...
        paymentLink: "https://paystack.com/pay/8rui1hjngm"
    },
    {
        id: 15,
        name: "DataInsight Analytics Platform",
        description: "Turn raw data into actionable insights with powerful visualization tools and predictive analytics. Make smarter business decisions faster.",
        price: 400000,
        old: 850000,
        discount: 53,
        images: [
            "products-images/data-1.png",
            "products-images/data-2.png",
            "products-images/data-3.png"
        ],
        paymentLink: "https://paystack.com/pay/z68hzp4ltl"
    }
=======
    }  
>>>>>>> 8bf7a3e (Update: Removed old images, added new ones, and fixed scripts)
];
